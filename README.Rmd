...
Use a dataframe with species distribution data. The dataframe must contain at least the 3 columns: 'species', 'decimalLongitude', and 'decimalLatitude'. The data frame can contain many other columns. 

If it is not validated perhaps can be a new record. After double check, please consider to write a small note to Mammalogy Notes updating the distribution.  
